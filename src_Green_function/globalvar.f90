...
real(kind=8)::xsource=0.0d3,ysource=0.0d0,zsource=-7.5d3!Nucleation point.
!===================================================================!
...
real(kind=8)::xmin=-30.0d3,xmax=30.0d3,ymin=-30.0d3,ymax=31.0d3,zmin=-30.0d3,zmax=0.0d0
...
character(len=15)::projectname='DynamicInversionv5',author='D.Liu'
!===================================================================!
